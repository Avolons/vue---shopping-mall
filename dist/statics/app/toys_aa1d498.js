    ...
    methods: {
        ...
        goToMore: function goToMore(act_id, store_id, name) {
            if (navigator.userAgent.toLowerCase().match(/Alipay/i) != "alipay") {
                window.location.href = "https://weixin.zujiekeji.cn/#/moreHot/?name=" + name + "&type=act&id=" + act_id + "&store_id=" + store_id + "&shebei=" + this.currentType;
            } else {
        ...
        goodClick: function goodClick(id) {
            if (this.currentType == 1) {
                ...
                if (navigator.userAgent.toLowerCase().match(/Alipay/i) != "alipay") {
                    window.location.href = "https://weixin.zujiekeji.cn/#/goodsInfo/" + id;
                } else {
        ...
        storeClick: function storeClick(id) {
            if (this.currentType == 1) {
                ...
                if (navigator.userAgent.toLowerCase().match(/Alipay/i) != "alipay") {
                    window.location.href = "https://weixin.zujiekeji.cn/#/shop/" + id;
                } else {
