...
var App = new Vue({
    ...
    methods: {
        ...
        goToMore: function goToMore(act_id, store_id, name) {
            window.location.href = "/#/moreHot/?name=" + name + "&type=act&id=" + act_id + "&store_id=" + store_id;
        },
        ...
        typeCheck: function typeCheck() {
            ...
            var isWeixin = navigator.userAgent.toLowerCase().match(/MicroMessenger/i) == "micromessenger" && navigator.userAgent.toLowerCase().match(/Alipay/i) == "alipay";
    ...
    mounted: function mounted() {
        ...
        var self = this;
        localStorage.setItem('isAPP', self.currentType);
        $.ajax({
