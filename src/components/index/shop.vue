<style >
  ...
  .footer_style_1{ position: fixed; bottom: 53px; width: 100%; background: #fff}
...
<template>
	<div>
	   <h1 class="shop_title">购物车
            <span class="shop_changeAll">编辑全部</span>
        </h1>
     <div class="content">
          ...
          <div class="weui_cells_checkbox list_cell_4" @click="zongji">
            <label class=" weui_check_label" >
              <div class="weui_cell_hd">
                <input type="checkbox" class="weui_check each" id="checkbox"  checked="true">
                <i class="weui_icon_checked"></i>
              </div>
            </label>
          </div>
        
          <a style="width:50%;display: inline-block;" class="list_cell_5">
              <img :src="'http://oidluqi4c.bkt.clouddn.com/'">
            </a>
          <div class="list_cell_6">
             <p></p>
             <strong>￥</strong>
             <div class="weui-row num_box_1">
                <div class="weui-col-33"><span class="num_icon_1"><a >&#45;</a></span></div>
                <div class="weui-col-33"><span class="title_txt_1"><h2></h2></span></div>
                <div class="weui-col-33"><span class="num_icon_2"><a &#43;</a></span></div>
             </div>
          </div>
      </div>
      </div>
